...
$text_msg = sprintf("Nome mittente: %s\n E-mail mittente: %s\n Corpo messaggio: %s", $_POST['name'], $_POST['email'], $_POST['message']);
$html_msg = $text_msg;
...
FORPSI";  // aggiungi il messaggio in formato text
...
FORPSI";  // aggiungi il messaggio in formato HTML
